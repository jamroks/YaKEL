...
première étape, activé l'environement virtualenv et installation d'ansible. Pour ce faire, recuperer les sources depuis github à partir du présent repository tel que décrit ci-dessous.
...
Le provisioning des trois noeuds du cluster, composé d'un master et deux workers, peut se faire en une seul étape, pour les impatients il suffit de lancer la commande vagrant habituel 
...
Par soucis de clarté je vais décomposé les étapes en 3 commandes: 
